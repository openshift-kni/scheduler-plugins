...
require (
	...
	k8s.io/cloud-provider v0.31.7 // indirect
	k8s.io/controller-manager v0.31.7 // indirect
	k8s.io/csi-translation-lib v0.31.7 // indirect
	k8s.io/dynamic-resource-allocation v0.31.7 // indirect
	k8s.io/gengo/v2 v2.0.0-20240228010128-51d4e06bde70 // indirect
	k8s.io/kms v0.31.7 // indirect
	k8s.io/kube-openapi v0.0.0-20240228011516-70dd3763d340 // indirect
	k8s.io/kubelet v0.31.7 // indirect
	k8s.io/metrics v0.31.7 // indirect
	k8s.io/mount-utils v0.31.7 // indirect
