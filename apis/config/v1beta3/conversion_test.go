...
func TestConvert_v1beta3_NodeResourceTopologyMatchArgs_To_config_NodeResourceTopologyMatchArgs(t *testing.T) {
	testCases := []struct {
		name        string
	...
	for _, tc := range testCases {
		...
		err := Convert_v1beta3_NodeResourceTopologyMatchArgs_To_config_NodeResourceTopologyMatchArgs(tc.in, got, nil)
...
func TestConvert_config_NodeResourceTopologyMatchArgs_To_v1beta3_NodeResourceTopologyMatchArgs(t *testing.T) {
	testCases := []struct {
		name        string
	...
	for _, tc := range testCases {
		...
		err := Convert_config_NodeResourceTopologyMatchArgs_To_v1beta3_NodeResourceTopologyMatchArgs(tc.in, got, nil)
