...
// Package formatr implements formatting of structured log messages and
...
// # Custom LogSinks
//
// For users who need more control, a formatr.Formatter can be embedded inside
...
// values which are being logged.  When rendering a struct, formatr will use Go's
